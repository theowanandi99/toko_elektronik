                ...
                <div class="carousel-item active">
                    ...
                    <div class="container">
                        <div class="carousel-caption relative">
                            ...
                            <a class="buynow" href="barang.php">Daftar Barang</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="container">
                        <div class="carousel-caption relative">
                            ...
                            <p>Daftarkan diri anda segera untuk mendapatkan berbagai promo menarik
                                <br> dan potongan harga dari toko Jaya Elektronik</p>
                            <a class="buynow" href="registrasi.php">Registrasi</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="container">
                        <div class="carousel-caption relative">
                            ...
                            <p>Silakan login ke sistem untuk melakukan transaksi pemesanan barang
                                <br> dan pembayaran serta memperoleh promosi menarik dari toko Jaya Elektronik</p>
                            <a class="buynow" href="login.php">Login</a>
                        </div>
                    </div>
                </div>
            </div>
