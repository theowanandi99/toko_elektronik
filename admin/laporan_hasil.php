        ...
        <div class="container">
            <table class="table table-striped table-hover">
              ...
              <?php
                ...
                $query = "Select h.*, c.namacust, c.alamat, c.nohp from pemesanan h inner join customer c on h.kodecust = c.email where tanggal >= '$tanggal1' AND
						  tanggal <= '$tanggal2'";
                ...
                while ($data = mysqli_fetch_row($hasil))
                {
                    ...
                    <tr>
                        ...
                        <td><a href='laporan_detail.php?id=$data[0]' type='submit' class='btn btn-primary'>Hapus</a></td>
                    </tr>";
                }				
